...
export const getCampaignPushConsent = (
  payload: Payload,
  req?: ConsentRequest,
): Promise<ConsentDescriptor | null> => getConsentByKey(payload, CAMPAIGN_PUSH_CONSENT_KEY, req)

export const requireCampaignPushConsent = (
  payload: Payload,
  req?: ConsentRequest,
