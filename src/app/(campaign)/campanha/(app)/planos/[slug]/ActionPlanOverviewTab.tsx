...
import { ActionPlanResultForm } from '@/components/campaign/actionPlan/ActionPlanResultForm'
import { Badge } from '@/components/ui/Badge'
import { Button } from '@/components/ui/button'
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card'
import { actionPlanOriginLabels } from '@/lib/schemas/actionPlan'
import { campaignDemandKindLabels, campaignDemandStatusLabels } from '@/lib/schemas/campaignDemand'
import type { getActionPlanDetailPageData } from '@/utilities/actionPlanDetailPageData'
...
type ActionPlanDetailView = Awaited<ReturnType<typeof getActionPlanDetailPageData>>

/** The "Visão geral" tab: details, team/orgs, linked demands and the result block. */
export const ActionPlanOverviewTab = ({
  view,
  isStaff,
}: {
  view: ActionPlanDetailView
  isStaff: boolean
}) => (
