...
export default function Page() {
  return (
    <main className="w-screen h-screen bg-[url(/BG.jpg)] bg-center bg-cover flex flex-col items-center justify-center">
      <div className="flex flex-col max-w-300 gap-12">
        ...
        <div className="relative flex flex-col items-center gap-0">
          <Image src="LOGO_SOLLA_BRANCO.svg" width={430} height={300} alt="" className="-my-30" />
