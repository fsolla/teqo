...
const consentDefinitions: Record<Onda0ConsentKey, string[]> = {
  [ONDA0_CONSENT_KEYS.leadershipAutofill]: [
    ...
    'Finalidade: registrar e atualizar seus dados de contato (nome, telefone, e-mail, setor) para participação como liderança de campanha vinculada a um núcleo eleitoral, incluindo acesso à área interna /campanha quando aplicável.',
    'Dados tratados: nome, telefone, e-mail, setor e vínculo com o núcleo. Não coletamos dados sensíveis neste fluxo.',
  ...
  [ONDA0_CONSENT_KEYS.supporterRegistration]: [
    ONDA0_PROVISIONAL_BANNER,
    'Finalidade: registrar seu apoio declarado à campanha de Jorge Solla, permitindo contato organizado pela equipe de campanha e eventual vinculação a um núcleo eleitoral.',
...
export const ONDA0_PRIVACY_POLICY_BODY: LexicalRoot = buildLexicalFromParagraphs([
  ...
  'Finalidades: organização de núcleos eleitorais, cadastro de apoiadores, comunicação com lideranças e equipe, operação de agenda e inteligência eleitoral interna, sempre conforme a finalidade informada no momento da coleta.',
