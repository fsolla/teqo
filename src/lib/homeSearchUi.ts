...
export const HOME_SEARCH_GROUP_HEADING_CLASS = 'text-xs font-normal text-muted-foreground'

export const HOME_SEARCH_GROUP_LIST_CLASS = 'm-0 list-none p-0 [&>li]:mt-0'
