/**
 * Degenerate omnibox for lists that only expose free-text search.
 * Pure / client-safe. (Organizações graduated to a typed omnibox — chips + apply remain for search-only surfaces / B128 pins.)
 */
