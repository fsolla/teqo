...
/**
 * S22/S25 — the home sound section (artefato: cenas 01/02/06/07 do S22; o
 * player da rádio é o do S25, cenas 01–05): the Rádio 1313 player (próprio,
 * `preload="none"`, desde o S25) followed by up to three published jingles and
 * the "Ver todos" handoff to `/jingles` when more exist. With zero published
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-[1160px] px-5 py-12 sm:px-8 lg:px-10 lg:py-16">
        ...
        <RadioPlayer compact={!hasJingles} />
