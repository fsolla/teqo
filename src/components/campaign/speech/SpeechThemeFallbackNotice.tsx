...
/**
 * C192 — the discreet fallback notice when `mode=tema` was asked but the theme
 * expansion was unavailable. The list below shows the literal results; the
 * notice keeps the user's request honest instead of hiding the downgrade.
 */
