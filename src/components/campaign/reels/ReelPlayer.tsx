...
export const ReelPlayer = ({ reel }: { reel: ReelDetailViewModel }) => {
  if (!reel.videoSourceUrl) {
    return (
      <div className="mx-auto flex aspect-[9/16] w-full max-w-[330px] flex-col items-center justify-center gap-1 rounded-xl border border-dashed bg-muted/40 p-4 text-center">
  ...
  return (
    <video
      ...
      className="mx-auto aspect-[9/16] w-full max-w-[330px] rounded-xl border bg-black"
    />
  )
}
