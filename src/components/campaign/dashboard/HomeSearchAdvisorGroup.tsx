...
export const HomeSearchAdvisorGroup = () => {
  ...
  const hitLimit = useHomeSearchHitLimit('advisors')
  ...
  const visibleAdvisors = sliceHomeSearchHits(advisors, hitLimit)
  if (visibleAdvisors.length === 0) return null
