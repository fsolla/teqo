...
export const MUNICIPALITY_UNIT = {
  ...
  /** Guard printed in "O essencial"/synthesis for the city recorte (C209). */
  synthesisSumGuard: 'Região e polo não são somados ao município.',
}
...
export const THEME_UNIT = {
  ...
  /** Theme money lines keep every phase on its own line (never fused). */
