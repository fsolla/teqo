...
export const E2E_AFFECTED_MANIFEST = [
  ...
  },
  {
    prefixes: [
      ...
      'src/lib/wizardBack',
      'src/components/campaign/shared/CampaignWizard',
  ...
  // the affected classifier cannot return mode=none on an unmapped domain dir.
  {
    prefixes: [
      ...
      'src/components/campaign/shared/WizardExpectedVotesStep',
      'src/components/campaign/shared/useWizardNearestMunicipality',
      'src/lib/wizardMunicipalitySuggestMerge',
      'src/lib/wizardThumbGrid',
      'src/lib/municipalitySignalTypeMeta',
      'src/lib/politicalTrendWizardMeta',
      'src/lib/politicalTrendWizardUi',
