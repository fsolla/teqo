...
describe('admin bypasses carry a justification comment', () => {
  ...
  const pinnedUndocumented = new Map<string, number>([
    ...
    ['src/app/(campaign)/campanha/actions/leadership.ts', 1],
    ...
    ['src/app/(campaign)/campanha/actions/supporter.ts', 7],
