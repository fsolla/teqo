...
export default function Page() {
  return (
    <main className="h-full grid grid-cols-2 grid-rows-[auto_min-content_min-content_min-content_min-content] gap-4 px-4 pb-17.5 pt-42">
      <h1 className="text-center col-span-2">Teko</h1>
      <Route
        variant="terciary"
        href="welcome/import-private-key/network"
        label="Import private key"
      />
      <Route
        variant="terciary"
        href="welcome/connect-wallet/choose"
        label="Connect wallet"
      />
      <Route
        variant="secondary"
        href="/welcome/connect-hardware-wallet"
