...
3. **Depth and simplicity as peers** — staff workflows can be rich; leadership paths stay light and phone-first without becoming a second-class product.
4. **Intelligence serves organization** — electoral baseline and insights exist to decide where to act, not to impress.
5. **Inspire without kitsch** — socialist and mobilizing in spirit; never shouty campaign brochure aesthetics.
