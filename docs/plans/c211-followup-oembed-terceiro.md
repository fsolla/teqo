...
Status: entregue (2026-09-23 — refinamento datado nos planos do C211; sem código)
...
A investigação do C212 (Issue #1256, achados em `docs/plans/central-conteudos-varredura-instagram.md` §Q2) provou que o oEmbed do Instagram só serve para **renderizar** o post embutido (visão de front-end): "consuming, manipulating, extracting, or persisting the metadata and content … is strictly prohibited" (doc datada em 2026-09-22; probe sem credencial devolveu 403 `(#200) Provide valid app ID` ao pedir metadados). A hipótese B ("entra com thumbnail/embed quando o caminho oficial permitir") vivia na questão do **C212** (`central-conteudos-varredura-instagram.md:79`) — o plano do C211 (Issue #1254) nunca a carregou: sua questão "Peça por link: circula ou é baixada?" já dizia "mídia de terceiro nunca é baixada" e ficou marcada "_(decidido — refinar no C212)_", interpretável como persistir thumbnail de terceiro, o que a plataforma proíbe. _(Correção 2026-09-23 — Issue #1263: atribuição corrigida; a premissa original apontava a hipótese B para o plano do C211.)_
...
- _(Fechamento 2026-09-23 — Issue #1263)_ Aplicado: a regra entrou em `docs/plans/central-conteudos-ingestao.md:68,105` e no D4 do impl (`central-conteudos-ingestao-impl.md:105,195,229`). O aceite `:49` do C211 **não** prometia thumbnail de terceiro — nada a alinhar lá (condicional do aceite acima resolvida como falsa).
