...
- CI: o check `checks` do PR #1321 falhou por uma **quebra pré-existente da main** — o S40 (`2515e86b`) sobrescreveu a arte aprovada em `docs/plans/cards-estadual-dobradinha-ui-design-assets/modelo-time-de-voce-com-estadual.jpeg` e o pin do S30 (`tests/unit/stateDeputyCatalog.unit.spec.ts`) passou a divergir; os deploys de S40/S39 na main também falharam (auto-unblock: Issue #1319; S40: Issue #1316). O merge aguarda a main voltar ao verde para rebase e novo run — nada do fix dos tiles depende disso.
