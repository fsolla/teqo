...
- **E7 Escala e DRY pós-E2 registrado (2026-07-19)** — débitos do `/simplify` que não entraram no cleanup: trend VM único no detalhe (sem série duplicada baseline+insights), testes int de `loadNucleusListElectionOverview` (gap + tendência **+ conversão A5-1**), tipo único `VoteTrendDistribution`. [Plano](plans/escala-dry-pos-e2.md).
...
| E7 Escala e DRY pós-E2                   | — (sem design novo; reusa Baseline + Insights + overview tendência/conversão)   | [escala-dry-pos-e2.md](plans/escala-dry-pos-e2.md)                                                                                                                                                                                                                                                                                                                     |
