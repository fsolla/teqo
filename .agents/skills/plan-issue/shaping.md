...
Se o item muda UI: design hi-fi no gate ([ui-design-html.md](ui-design-html.md)) antes de registrar — não conta como “engenharia no plano”; é validação visual da intenção.
